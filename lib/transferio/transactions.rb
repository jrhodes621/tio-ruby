module TransferIO
  class Transactions
    ...
    def create transaction_type, account_holder_name, account_type, routing_number, account_number, amount
      formatted_amount = (amount.to_f*100).to_i
    ...
    def parse_response(response)
      ...
      when 200
        ...
        @parsed_response[:transaction_id] = response["id"]
        @parsed_response[:confirmation_number] = response["confirmation_number"]
        @parsed_response[:transaction_status] = response["transaction_status"]
